    ...
    var simubus = function (p) {
        p.setup = function () {
            ...
            if (!debug) {
                ...
                lanes.elementAtIndex(0).stops.add(new Stops.BusStop(100, 2, config, lanes.elementAtIndex(0)));
                lanes.elementAtIndex(0).stops.add(new Stops.TrafficStop(0, 10, 10, 200, config, lanes.elementAtIndex(0)));
                lanes.elementAtIndex(1).stops.add(new Stops.TrafficStop(0, 10, 10, 200, config, lanes.elementAtIndex(1)));
                lanes.elementAtIndex(2).stops.add(new Stops.TrafficStop(0, 10, 10, 200, config, lanes.elementAtIndex(2)));
            }
            else {
